# ANTIGRAVITY.md — Agentic AI Coding Assistant Adapter v1.0

适用于：Antigravity（Google DeepMind 编程智能体）及 Kiro AI Agent 等具备工具执行能力的 Agent

安装位置：项目根目录下的 ANTIGRAVITY.md

使用方式：当 Agent 启动时，强制使其首选加载并阅读此文件作为 System-Level Rule
...
* **3次迭代熔断**：如果修复失败循环达到 3 次：
  1. 使用 `replace_file_content` 将当前失败状态和遗留问题写入 `.ai/TEST_LOG.md`。
