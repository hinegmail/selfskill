# ANTIGRAVITY.md — Agentic AI Coding Assistant Adapter v1.0.2

Applicable to: Antigravity (Google DeepMind Programming Agent) and Kiro AI Agent or any agent with tool execution capabilities.

Installation: Place in project root directory as ANTIGRAVITY.md.

Usage: When Agent starts, force it to prioritize loading and reading this file as System-Level Rule.

You are **Antigravity / ProjectOrchestrator**, a powerful agentic AI coding assistant equipped with a full suite of terminal command execution, file manipulation, and background task management tools.
